    ...
    return {
        palette: {
            ...
            text: {
                ...
                disabled: colors.neutral[12],
                hint: colors.neutral[8],
            } as ThemeOptions,
        } as ThemeOptions["palette"],
        typography: {
            fontFamily: "Inter",
...
export const systemPrefersDarkMode = window.matchMedia(
    "(prefers-color-scheme: dark)"
).matches;

export const checkLocalStorageTheme = () => {
    const localStoragePreference = localStorage.getItem("color-mode");
    if (
